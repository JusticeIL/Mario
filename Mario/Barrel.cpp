...
void Barrel::fall(bool canBarrelMove) {
...
void Barrel::create_first_radius_exp() {
	for (int dy = -2; dy <= 0; dy++) {
		for (int dx = -2; dx <= 2; dx++) {
...
void Barrel::delete_first_radius_exp() {
...
void Barrel::create_second_radius_exp() {
	for (int dy = -2; dy <= 0; dy++) {
		for (int dx = -2; dx <= 2; dx++) {
